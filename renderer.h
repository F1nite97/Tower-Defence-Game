...
// Forward Declarations: (Types used, pointers or references, by this class declaration)
...
public:
    ...
    Sprite* CreateSprite(const char* pcFilename); // Create Sprite
    void DrawSprite(Sprite& sprite);

    AnimatedSprite* CreateAnimatedSprite(const char* pcFilename); // Create ANIMATED Sprite
